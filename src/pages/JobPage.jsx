...
const JobPage = ({deleteJob}) => {
    ...
    const onClickDelete = (jobId) => {
        const confirm = window.confirm('are u sure u want to delete this listing job?')

        if(confirm){
            deleteJob(jobId);
            toast.success('the job delete successfully')
            return navigat('/jobs')
        }else{
            toast.error('U Keep The Job a Life')
            return
        }
    }
        ...
        <section className="bg-teal-500">
            <div className="container m-auto py-10 px-6">
                ...
                <main>
                    ...
                    <h3 className="text-blue-600 text-lg font-bold mb-2">Salary</h3>
                ...
                <aside>
                    ...
                    <p className="mt-2 bg-indigo-100 p-2 font-bold">{job.company.contactPhone}</p>
                    </div>
